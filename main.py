...
def check_password(candidate, database):
    ...
    Returns
    -------
    (accepted, closest_password, (jaccard, dice, cosine), all_rows)
    ...
    return accepted, best_match, (best_j, best_d, best_c), all_rows
...
def run_demo():
    ...
    for candidate, label in test_cases:
        ...
        accepted, closest, (j, d, c), all_rows = check_password(candidate, db)
...
def run_interactive(database):
    ...
    while True:
        ...
        # Full JUSTIF table
        accepted, closest, (j, d, c), all_rows = check_password(candidate, database)
